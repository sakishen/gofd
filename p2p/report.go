...
func (r *reporter) DoReport(serverAddr string, fileType int, gid int, version int, storageDir string, pecent float32) {
	r.reportChan <- &reportInfo{serverAddr: serverAddr, fileType: fileType, gid: gid, version: version, storageDir: storageDir, percentComplete: pecent}
}
